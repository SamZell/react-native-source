...
/**
 * 一个简单的工厂创建{@link DevSupportManager}的实例，如果它存在的话就使用反射去创建DevSupportManagerImpl，
 *
...
public class DevSupportManagerFactory {
  ...
  public static DevSupportManager create(
    ...
    try {
      ...
      // confuse it.
      String className = new StringBuilder(DEVSUPPORT_IMPL_PACKAGE)
          .append(".")
          .append(DEVSUPPORT_IMPL_CLASS)
          .toString();

      Class<?> devSupportManagerClass = Class.forName(className);
      Constructor constructor =devSupportManagerClass.getConstructor(Context.class,ReactInstanceDevCommandsHandler.class,
          String.class,
          boolean.class,
          RedBoxHandler.class);
