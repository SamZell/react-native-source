...
/**
 * 本地代码的规格，这个类的作用就在于我们不需要为要用的时候创建，花费代价，
 ...
 * 如果你的模块有一个模块默认的构造函数或一个调用 ReactApplicationContext你可以用{@link #simple(Class)}
 * 或{@link #simple(Class, ReactApplicationContext)}} 方法
