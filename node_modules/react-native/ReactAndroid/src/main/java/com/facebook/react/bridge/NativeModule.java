...
/**
 * 本地模块的API可以提供给JS催化剂实例, {@link NativeModule}s的实现要写到java都应该继承{@link BaseJavaModule}或是{@link ReactContextBaseJavaModule}
 * {@link NativeModule} 实现类要写到c++里不提供java代码（为了复用）,使用他们要在{@link com.facebook.react.cxxbridge.CxxModuleWrapper}
